...
class TopRatedMovies extends Component {
  ...
  getTopMovies = async () => {
    ...
    const apiUrl =
      'https://api.themoviedb.org/3/movie/top_rated?api_key=93ece72962107beded98f9e7daca0b47&language=en-US&page=1'
    ...
    return (
      <MoviesContext.Consumer>
        {value => {
          ...
          const filterMovies = topMovies.filter(eachItem =>
