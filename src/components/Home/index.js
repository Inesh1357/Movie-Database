...
class Home extends Component {
  ...
  getPopularMovies = async () => {
    ...
    const apiUrl = `https://api.themoviedb.org/3/movie/popular?api_key=93ece72962107beded98f9e7daca0b47&language=en-US&page=1`
    ...
    if (response.ok === true) {
      ...
      this.setState({
        popularMovies: updateMoviesData,
    ...
    return (
      <MoviesContext.Consumer>
        {value => {
          ...
          const filterMovies = popularMovies.filter(eachItem =>
